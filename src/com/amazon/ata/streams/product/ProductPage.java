...
public class ProductPage {
     ...
     *
     * As per https://api.corp.amazon.com/operations/TPvRr1W3vu/productImages picks the first image from
     * the list as the main image instead of using the "MAIN" image variant" which apparently is not
     * necessarily the main image.
     *
     * Golf score: 18
     * Par: 8
     * Your score: 8
...
//        }
        ...
        return productV2.productImages()
                ...
                .map(image -> extractImageUrl(image, longestDimension))
                    // extract each image to ensure that it's null or not
                .filter(Objects::nonNull)
                    // grab all Objects that are not null
                .findFirst();
    }
...
//        }
    ...
    /**
     * Get products to display from API.
     *
...
//************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************
    ...
    private Map<SortByEnum, Comparator<ProductV2>> createSortComparatorMap() {
        ...
        comparatorMap.put(REWARD_HIGH_TO_LOW, Comparator.comparing(ProductV2::getTotalBenefitAmount)
                .reversed());
